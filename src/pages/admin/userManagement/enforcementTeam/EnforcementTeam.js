    ...
    <div className="row">
        ...
        {isTeamExists ? (
          <div className="panel-card">
            <div className="card-body">
              ...
              <div>
                <p className="text-center fs-20 fw-600">Enforcement Team</p>
              ...
              <div className="row">
                <div className="col p-1">
                  <button
                    ...
                    onClick={() => {
                      navigate("/enforcement-team-details");
                    }}
                  >
                ...
                <div className="col p-1">
                  <Popconfirm
                    ...
                    description="Are you sure to delete this Enforcement Team account?"
                    onConfirm={confirm}
                    onCancel={cancel}
                    okText="Yes"
                    cancelText="No"
      ...
      <div className="col-lg-8 ">
        <div className="form-card form-sm-custom-style mb-4 position-relative">
          {!isTeamExists || isEdit ? "" : <div className="overlap"></div>}
          <div>
            <p className="primary-color fw-500 fs-22 text-decoration-underline">
              {!isEdit ? "Add" : "Edit"} Enforcement Team
            </p>
          </div>
          <Form
            form={form}
          ...
          >
            ...
            <div className="row ">
              <div className="col-md-12">
                <button className="btn form-btn" disabled = {!isTeamExists || isEdit ? false :true} >
                  {!isEdit ? "Add Enforcement Team" : "Save"}
                </button>
              </div>
            </div>
          </Form>
