...
function StateGovtAgencyDetails() {
  const breadcrumbItems = [
    { label: "User Management" },
    { label: "State Government Agency", url: "/state-govt-agency" },
    { label: "State Government Agency Details" },
  ];
  return (
...
export default StateGovtAgencyDetails