    ...
    <div className="row">
        ...
        {isAgencyExists ? (
          <div className="panel-card">
            <div className="card-body">
              ...
              <div>
                <p className="text-center fs-20 fw-600">State Government Agency</p>
              ...
              <div className="row">
                <div className="col p-1">
                  <button
                    ...
                    onClick={() => {
                      navigate("/state-govt-agency-details");
                    }}
                  >
            ...
            <div className="card-body">
              <div className="text-center">
                ...
                <p className="fw-600 fs-20">
                  No State Government Agency Added
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="col-lg-8 ">
        <div className="form-card form-sm-custom-style mb-4 position-relative">
          {!isAgencyExists || isEdit ? "" : <div className="overlap"></div>}
          <div>
            <p className="primary-color fw-500 fs-22 text-decoration-underline">
              {!isEdit ? "Add" : "Edit"} State Government Agency
            </p>
          </div>
          <Form
            form={form}
          ...
          >
            ...
            <div className="row ">
              <div className="col-md-12">
                <button className="btn form-btn" disabled = {!isAgencyExists || isEdit ? false :true} >
...
export default StateGovtAgency